...
### exec()
*exec()* is a set of a bunch of functions. They generally loads a new program into a process's memory. This enables a the processes generated by fork() to execute different functions. 
